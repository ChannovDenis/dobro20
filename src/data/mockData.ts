...
export const feedItems: FeedItem[] = [
  ...
  // Mini-app promos — GPB, MES, MSB
  {
    id: "promo-gpb",
    type: "miniapp-promo",
    title: "AI-Архитектор: дизайн интерьера за минуту",
    description: "Загрузите фото комнаты — получите 3D-визуализацию, подбор стиля и смету от AI",
    image: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&h=1400&fit=crop",
    tags: ["Приложение", "Дизайн"],
    miniAppId: "gpb-architect",
    ctaText: "Попробовать",
    likes: 0,
    comments: 0,
    shares: 0,
  },
  {
    id: "promo-mes",
    type: "miniapp-promo",
    title: "Защита и справедливость: проверь свои квитанции",
    description: "AI проанализирует ваши счета за ЖКХ, найдёт переплаты и поможет вернуть деньги",
    image: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=800&h=1400&fit=crop",
    tags: ["Приложение", "ЖКХ"],
    miniAppId: "mes-protection",
    ctaText: "Проверить квитанцию",
    likes: 0,
    comments: 0,
    shares: 0,
  },
  {
    id: "promo-msb",
    type: "miniapp-promo",
    title: "AI для бизнеса: 15+ навыков в одном месте",
    description: "Юрист, бухгалтер, маркетолог, HR — все AI-эксперты для малого и среднего бизнеса",
    image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=1400&fit=crop",
